...
const avatars = [
  'https://cdn-icons-png.flaticon.com/512/2823/2823511.png', // Alipay
  'https://cdn-icons-png.flaticon.com/512/2823/2823511.png', // Angular
  'https://gw.alipayobjects.com/zos/rmsportal/dURIMkkrRFpPgTuzkwnB.png', // Ant Design
  'https://cdn-icons-png.flaticon.com/512/2103/2103633.png', // Ant Design Pro
    ...
    data: [
      {
        ...
        title: titles[0],
        logo: avatars[0],
        description: '使用开源数据集训练的演进异味重构模型',
        //updatedAt: new Date(),
        member: '赵大宝',
        href: '',
        memberLink: '',
      ...
      },
      {
        ...
        title: titles[3],
        logo: avatars[3],
        description: '使用本团队内部数据集训练的演进异味重构模型',
